...
Assert-Contains 'src/Services/IdentityService/IdentityService.Api/Endpoints/RoleEndpoints.cs' 'if (!HasMfa(http)) return Results.Forbid();' 'role publish and rollback require step-up MFA'
