"""Issue a Harbor certificate signed by the existing His.Hope local CA.

Generated key material is deliberately written outside the repository.
"""
...
OUT_CERT = ROOT / "harbor_cert.pem"
OUT_KEY = ROOT / "harbor_key.pem"

names = [
    "harbor.his-hope.local",
    "harbor-k3s.his-hope.local",
    "harbor",
    "harbor.harbor",
    "harbor.harbor.svc",
...
print(f"Issued {OUT_CERT} with {len(names)} Harbor DNS SANs")
