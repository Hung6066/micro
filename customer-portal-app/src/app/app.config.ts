...
function defaultCustomerPortalRuntimeSource() {
...
export function createCustomerPortalRuntimeConfig(

  source = defaultCustomerPortalRuntimeSource(),
...
const runtime = createCustomerPortalRuntimeConfig();
