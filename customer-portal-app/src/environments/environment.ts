...
export const environment = {
  ...
  oidc: {
    ...
    redirectUrl: "http://localhost:4203/auth/callback",
    postLogoutRedirectUri: "http://localhost:4203/auth/login",
    silentRenewUrl: "http://localhost:4203/auth/silent-refresh",
