...
public sealed class NoopCommerceOrderPersistence : ICommerceOrderPersistence
{
    public Task SaveOrderAndOutboxAsync(
        CommerceOrderSnapshot order,
        CommerceOrderPlacedV1 @event,
        CancellationToken cancellationToken = default) => Task.CompletedTask;

    public Task<IReadOnlyList<CommerceOrderView>> GetOrdersAsync(
        string tenantKey,
        string? buyerUserId = null,
        CancellationToken cancellationToken = default) =>
        Task.FromResult<IReadOnlyList<CommerceOrderView>>([]);

    public Task<CommerceOrderView?> GetOrderAsync(
        Guid orderId,
        string tenantKey,
        CancellationToken cancellationToken = default) =>
        Task.FromResult<CommerceOrderView?>(null);

    public Task<CommerceOrderView?> UpdateOrderStatusAsync(
        Guid orderId,
        string tenantKey,
        string status,
        CancellationToken cancellationToken = default) =>
...
public sealed class NoopCommerceCatalogPersistence : ICommerceCatalogPersistence
{
...
public sealed class NoopCommerceCartPersistence : ICommerceCartPersistence
{
    public Task<CommerceCartSnapshot> GetCartAsync(
        string tenantKey,
        string userId,
        CancellationToken cancellationToken = default) =>
...
public sealed class NoopCommerceProfilePersistence : ICommerceProfilePersistence
{
    public Task<CommerceProfileSnapshot> GetProfileAsync(
        ...
        string fallbackEmail,
        CancellationToken cancellationToken = default) =>
        Task.FromResult(new CommerceProfileSnapshot(
            tenantKey,
            userId,
...
public sealed class NoopCommerceNotificationPersistence : ICommerceNotificationPersistence
{
...
public sealed class NoopCommerceRfqPersistence : ICommerceRfqPersistence
{
