...
public static class ManufacturingDemoSeeder
{
    ...
    public static void Seed(IDbContextFactory<ManufacturingDbContext> dbFactory)
    {
        ...
        db.Suppliers.Add(new ManufacturingSupplierEntity { Id = supplierId, TenantKey = TenantKey, Code = "SUP-MEKONG", Name = "Mekong Fresh Co.", Active = true, CreatedAt = SeededAt });
        ...
        db.Lots.AddRange(
            new ManufacturingLotEntity { Id = rawLotId, TenantKey = TenantKey, Sku = "RM-MANGO", Quantity = 500, Uom = "kg", Disposition = "Released", BestBefore = DateOnly.FromDateTime(SeededAt.AddDays(10).Date), CreatedAt = SeededAt },
            new ManufacturingLotEntity { Id = sugarLotId, TenantKey = TenantKey, Sku = "RM-SUGAR", Quantity = 50, Uom = "kg", Disposition = "Released", BestBefore = DateOnly.FromDateTime(SeededAt.AddDays(180).Date), CreatedAt = SeededAt },
            new ManufacturingLotEntity { Id = outputLotId, TenantKey = TenantKey, Sku = "FG-MANGO-CHILI", Quantity = 80, Uom = "kg", Disposition = "Released", BestBefore = DateOnly.FromDateTime(SeededAt.AddDays(365).Date), CreatedAt = SeededAt.AddHours(6) });
    ...
    private static Guid Id(string value) => Guid.Parse(value switch
    {
        ...
        "supplier-mekong" => "10000000-0000-0000-0000-000000000040", "rfq-mango-001" => "10000000-0000-0000-0000-000000000041", "quotation-mekong" => "10000000-0000-0000-0000-000000000042", "evaluation-mekong" => "10000000-0000-0000-0000-000000000043",
        ...
        "production-order-001" => "10000000-0000-0000-0000-000000000070", "production-batch-001" => "10000000-0000-0000-0000-000000000071", "operation-001" => "10000000-0000-0000-0000-000000000072", "reservation-production-001" => "10000000-0000-0000-0000-000000000073", "batch-input-001" => "10000000-0000-0000-0000-000000000074", "transformation-001" => "10000000-0000-0000-0000-000000000075", "loss-review-001" => "10000000-0000-0000-0000-000000000076",
    ...
    private static void MigrateLegacyTenant(ManufacturingDbContext db)
    {
        ...
        var tables = new[]
        {
            ...
            "manufacturing_storage_locations", "manufacturing_supplier_evaluations", "manufacturing_supplier_quotations",
            "manufacturing_supplier_rfqs", "manufacturing_suppliers", "manufacturing_transformations", "manufacturing_warehouses"
        };
