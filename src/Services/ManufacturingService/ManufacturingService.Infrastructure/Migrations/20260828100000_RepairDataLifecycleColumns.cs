...
[Migration("20260828100000_RepairDataLifecycleColumns")]
[DbContext(typeof(ManufacturingDbContext))]
public partial class RepairDataLifecycleColumns : Migration
{
    protected override void Up(MigrationBuilder migrationBuilder) => migrationBuilder.Sql("""
        ...
        BEGIN
            ...
            LOOP
                ...
                EXECUTE format('ALTER TABLE %I.%I ADD COLUMN IF NOT EXISTS is_deleted boolean NOT NULL DEFAULT false', item.table_schema, item.table_name);
    ...
    protected override void Down(MigrationBuilder migrationBuilder) =>
        throw new NotSupportedException("The lifecycle repair is additive and is not reverted automatically.");
}
