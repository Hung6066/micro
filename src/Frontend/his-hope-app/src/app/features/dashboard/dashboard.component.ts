...
export class DashboardComponent implements OnInit, OnDestroy {
  ...
  get encounterColumns() {
    return [
      {
        key: "encounterDate",
        label: this.i18n.t("dashboard.column.date", "Ngày"),
        sortable: true,
      },
      {
        key: "patientId",
        label: this.i18n.t("dashboard.column.patient", "Bệnh nhân"),
      },
      {
        key: "encounterType",
        label: this.i18n.t("dashboard.column.type", "Loại"),
      },
      {
        key: "chiefComplaint",
        label: this.i18n.t("dashboard.column.reason", "Lý do"),
      },
      {
        key: "status",
        label: this.i18n.t("dashboard.column.status", "Trạng thái"),
      },
    ];
  }
  get appointmentColumns() {
    return [
      ...
      {
        key: "startTime",
        label: this.i18n.t("dashboard.column.time", "Giờ"),
        sortable: true,
      },
      {
        key: "patientId",
  ...
  encounterFromRow(row: Record<string, unknown>): Encounter {
    return row["entity"] as Encounter;
  }
  appointmentFromRow(row: Record<string, unknown>): Appointment {
    return row["entity"] as Appointment;
  }
