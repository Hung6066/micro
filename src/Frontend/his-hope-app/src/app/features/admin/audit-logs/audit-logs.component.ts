...
export class AuditLogsComponent implements OnInit, OnDestroy {
  ...
  readonly columns: HisHopeDataTableColumn[] = [
    {
      key: "timestamp",
      label: this.i18n.t("auditLogs.column.timestamp", "Thời gian"),
    },
    {
      key: "userName",
      label: this.i18n.t("auditLogs.column.userName", "Người dùng"),
    },
    {
      key: "action",
      label: this.i18n.t("auditLogs.column.action", "Hành động"),
    },
    {
      key: "resourceType",
      label: this.i18n.t("auditLogs.column.resourceType", "Loại"),
    },
    {
      key: "resourceId",
      label: this.i18n.t("auditLogs.column.resourceId", "ID Tài nguyên"),
    },
    {
      key: "ipAddress",
      label: this.i18n.t("auditLogs.column.ipAddress", "Địa chỉ IP"),
    },
  ];
  ...
  readonly resourceOptions = [
    ...
    {
      value: "user",
      label: this.i18n.t("auditLogs.resourceUser", "Người dùng"),
    },
    { value: "role", label: this.i18n.t("auditLogs.resourceRole", "Vai trò") },
    {
      value: "patient",
      label: this.i18n.t("auditLogs.resourcePatient", "Bệnh nhân"),
    },
    {
      value: "appointment",
      label: this.i18n.t("auditLogs.resourceAppointment", "Lịch hẹn"),
    },
    {
      value: "encounter",
      label: this.i18n.t("auditLogs.resourceEncounter", "Lâm sàng"),
    },
    {
      value: "prescription",
      label: this.i18n.t("auditLogs.resourcePrescription", "Đơn thuốc"),
    },
    {
      value: "lab_order",
      label: this.i18n.t("auditLogs.resourceLabOrder", "Xét nghiệm"),
    },
    {
      value: "lab_result",
      label: this.i18n.t("auditLogs.resourceLabResult", "Kết quả XN"),
    },
    {
      value: "medication",
      label: this.i18n.t("auditLogs.resourceMedication", "Thuốc"),
    },
    {
      value: "invoice",
      label: this.i18n.t("auditLogs.resourceInvoice", "Hóa đơn"),
    },
    {
      value: "settings",
      label: this.i18n.t("auditLogs.resourceSettings", "Cài đặt"),
    },
  ];
      ...
      .subscribe({
        ...
        error: () => {
          ...
          this.error = this.i18n.t(
            "auditLogs.loadFailed",
            "Không thể tải nhật ký truy cập",
          );
