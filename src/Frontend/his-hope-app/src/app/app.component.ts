...
@Component({
    ...
    <mat-sidenav-container class="app-sidenav-container">
      ...
      @if (isLoggedIn) {
        <mat-sidenav
          #sidenav
          [mode]="sidenavMode"
          [opened]="isLoggedIn && sidenavOpened"
        >
          <div class="shell-sidebar">
            <div class="shell-sidebar__header">
              ...
              <button
                ...
                (click)="toggleSidenav()"
                [attr.aria-label]="
                  'app.sidebar.closeMenu' | hhTranslate: 'Đóng menu điều hướng'
                "
              >
            ...
            >
              ...
              >
                ...
                <span matListItemTitle>{{
                  "navigation.dashboard" | hhTranslate
                }}</span>
              </a>
              <a
                mat-list-item
              ...
              >
                ...
                <span matListItemTitle>{{
                  "navigation.patients" | hhTranslate
                }}</span>
              </a>
              <a
                mat-list-item
              ...
              >
                ...
                >
                <span matListItemTitle>{{
                  "navigation.appointments" | hhTranslate
                }}</span>
              </a>
              <a
                mat-list-item
              ...
              >
                ...
                >
                <span matListItemTitle>{{
                  "navigation.clinical" | hhTranslate
                }}</span>
              </a>
              <a
                mat-list-item
              ...
              >
                ...
                <span matListItemTitle>{{
                  "navigation.billing" | hhTranslate
                }}</span>
              </a>
              <a
                mat-list-item
              ...
              >
                ...
                <span matListItemTitle>{{
                  "navigation.administration" | hhTranslate
                }}</span>
              </a>
            </mat-nav-list>
          </div>
      ...
      <mat-sidenav-content>
        @if (isLoggedIn && isMobile && !sidenavOpened) {
          <button
            ...
            (click)="openSidenav()"
            [attr.aria-label]="
              'app.navigation.openMenu' | hhTranslate: 'Mở menu điều hướng'
            "
          >
        ...
        <div class="toolbar-actions">
          <button
            ...
            (click)="toggleTheme()"
            [attr.aria-label]="
              'app.theme.toggle' | hhTranslate: 'Đổi giao diện sáng/tối'
            "
          >
          ...
          @if (isLoggedIn) {
            <button
              ...
              (click)="logout()"
              [attr.aria-label]="
                'app.sidebar.logout' | hhTranslate: 'Đăng xuất'
              "
            >
  ...
  styles: [
    `
      ...
      .app-sidenav-container {
        min-height: 100dvh;
        background: var(--bg-warm, #f2f6f3);
      }
      .app-sidenav-container .mat-drawer-side {
      ...
      .shell-sidebar__nav .mdc-list-item__primary-text {
        font-family: var(--font-sans) !important;
      ...
      .shell-sidebar__nav a.active-link {
        background: var(--color-primary-soft);
        box-shadow: inset 3px 0 0 var(--color-primary);
        color: var(--color-primary);
      }
      .shell-sidebar__nav a.active-link:hover {
        background: var(--color-primary-soft);
      }
      .shell-sidebar__nav .mat-icon {
        color: var(--text-secondary);
        font-size: 20px;
        width: 20px;
        height: 20px;
      }
      .shell-sidebar__nav a.active-link .mat-icon {
        color: var(--color-primary);
      }
