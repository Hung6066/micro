...
import { DatabasePlatformApiService } from "../../core/services/database-platform-api.service";
...
describe("DatabasePlatformPageComponent", () => {
  it("marks the view for rendering after database resources load", () => {
    ...
    const api = jasmine.createSpyObj<DatabasePlatformApiService>(
      "DatabasePlatformApiService",
      ["getPlatformResources"],
    );
    api.getPlatformResources.and.returnValue(
      of([
        {
          name: "identitydb",
          type: "database",
    ...
    TestBed.configureTestingModule({
      providers: [
        { provide: DatabasePlatformApiService, useValue: api },
    ...
    const component = TestBed.runInInjectionContext(
      () => new DatabasePlatformPageComponent(),
    );
