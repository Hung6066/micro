...
@Component({
  ...
  styles: [`
    :host { display: block; }
    .hh-alert { display: flex; align-items: flex-start; gap: 10px; padding: 12px 14px; border: 1px solid; border-radius: var(--radius-card); }
    ...
    .hh-alert__content { flex: 1; min-width: 0; display: grid; gap: 3px; }
    .hh-alert__content strong { font-size: var(--font-size-body); }
    .hh-alert__close { display: grid; place-items: center; width: 32px; height: 32px; margin: -4px -4px 0 0; border: 0; background: transparent; color: inherit; cursor: pointer; }
  `],
})
