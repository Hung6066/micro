...
@Component({
  ...
  styles: [`
    ...
    .hh-form-section__title { padding: 0; color: var(--text-primary); font-size: var(--font-size-label); line-height: var(--line-height-compact); font-weight: var(--font-weight-semibold); }
    .hh-form-section__description { margin: var(--space-2xs) 0 var(--space-md); color: var(--text-secondary); font-size: var(--font-size-caption); line-height: var(--leading-body); }
