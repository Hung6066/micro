...
@Component({
  ...
  template: `
    <fieldset class="hh-form-section">
      @if (title()) {
        <legend class="hh-form-section__title">
          {{ title() | hhTranslate }}
        </legend>
      }
      @if (description()) {
        <p class="hh-form-section__description">
          {{ description() | hhTranslate }}
        </p>
      }
  ...
  styles: [
    `
      ...
      :host(.hh-form-section--span-2) {
        grid-column: 1 / -1;
      }
      .hh-form-section__title {
        padding: 0;
      ...
      .hh-form-section__description {
        margin: var(--space-1) 0 var(--space-3);
        color: var(--text-secondary);
        font-size: var(--font-size-caption);
        line-height: var(--leading-body);
      }
      .hh-form-section__content {
        display: grid;
