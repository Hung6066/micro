...
export class QualityInspectionsPageComponent implements OnInit, AfterViewInit {
  ...
  private applyTabVisibility(): void { const sections = Array.from(document.querySelectorAll<HTMLElement>("section.section")); sections.forEach((section, index) => section.hidden = index !== (this.activeTab === "record" ? 0 : 1)); }
